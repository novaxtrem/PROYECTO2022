    ...
    for (var i = 0; i < 1; i++) {
        ...
        htmlContentToAppend +=
            ...
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-6 col-md-2 quantity"><label class="form-label d-none d-md-block" for="quantity">Cantidad</label><input type="number" id="number" class="form-control quantity-input" value="1" disabled></div>
