...
//
//
$q = "INSERT INTO `ordenes_de_compras`(`orden_compra_id`, `orden_compra_vendedor_id`, `orden_compra_comprador_id`, `orden_compra_numero_operacion`, `orden_compra_direccion_envio`, `orden_compra_total`, `orden_compra_estado`) VALUES (DEFAULT,'$orden_compra_vendedor_id','$orden_compra_comprador_id',120430,'$orden_compra_direccion_envio',4900,'NUEVA')";
